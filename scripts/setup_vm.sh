...
uv run python -c "from example.models import TinyTransformer; print('example imports OK')"

echo ""
echo "=== Setup complete ==="
echo ""
echo "Next steps:"
echo "  1. Run a smoke test:     uv run python -m example.train.run trainer=cpu trainer.max_epochs=1"
